...
feedback_csv_path = "2025\\PeerDat.csv"
...
# for s in range(2, 3):
    ...
    writer.write(f"{savename}"+".pdf")
    shutil.rmtree("report_images//")
    os.remove("data_overlay.pdf")

BASE_DATA_PATH, _ = os.path.split(combined_csv_path)
os.remove(os.path.join(BASE_DATA_PATH, "combined_cleaned.csv"))
os.remove(os.path.join(BASE_DATA_PATH, "feedback_cleaned.csv"))
