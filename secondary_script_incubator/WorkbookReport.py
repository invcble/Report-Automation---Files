...
def gen_name_image(path, s):
    ...
    for each in Attitude_and_Motivation + Knowledge_Sharing + Teaming_Approach_and_Skills_II + Resistance_to_Change_Attitudes + Emotional_Intelligence + Belongingness_Uniqueness + Values:
    ...
    for each in Inclusive_Leadership:
